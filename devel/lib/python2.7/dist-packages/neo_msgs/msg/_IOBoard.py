...
class IOBoard(genpy.Message):
  _md5sum = "6e9085371cb5e95c2cbe1368025a2f19"
...
string frame_id
"""
  __slots__ = ['header','digital_inputs','digital_outputs','analog_inputs']
  _slot_types = ['std_msgs/Header','bool[16]','bool[16]','int16[8]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,digital_inputs,digital_outputs,analog_inputs
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_8h().pack(*self.analog_inputs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.analog_inputs = _get_struct_8h().unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.analog_inputs = numpy.frombuffer(str[start:end], dtype=numpy.int16, count=8)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
